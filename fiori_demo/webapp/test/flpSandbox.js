					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Fiori Demo App Title",
									"targetURL": "#nsfioridemo-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nsfioridemo-display": {
								"semanticObject": "nsfioridemo",
								"action": "display",
								"description": "Fiori Demo  SAP Fiori application.",
								"title": "Fiori Demo App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ns.fioridemo",
									"url": sap.ui.require.toUrl("ns/fioridemo")
								}
							}
						}
					}
